                    ...
                    {loading ? (
                        ...
                        <div className={style.tableContainer}>
                            <table className={style.table}>
                                ...
                                <tbody>
                                    {roomData.map((room) => (
                                        <tr key={room.roomId} className={style.tableRow}>
                                            <td className={style.tableCell}>{room.roomId}</td>
                                            <td className={style.tableCell}>{room.buildingName} - {room.roomname} Өрөө</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
